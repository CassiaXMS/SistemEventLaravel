            ...
            <div class="row justify-content-center align-items-start">
                <div class="col-lg-7">
                    <div class="section-title">
                        ...
                        <div class="mb-5">
                            ...
                            <p class="list-inline-item">Tipo: <a href="#!" class="ml-1">{{ $evento->tipo }} </a> </p>
                            <p class="list-inline-item">Categoria: <a href="#!" class="ml-1">{{ $evento->categoria->nome}} </a></p>
                            <p>Local: <a href="#!" class="ml-1">{{ $evento->endereco}} </a>, <a href="#!"
                                class="ml-1">{{ $evento->sala}}   ({{ $evento->capacidade }} pessoas)</a></p>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    ...
                    <div class="text-center mt-4">
                        <a class="btn btn-sm btn-outline-primary" href="service-details.html">INSCREVER <i class="las la-arrow-right ms-1"></i></a>
                    </div>
                </div>
